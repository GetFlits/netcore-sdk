...
class NetcoreTest extends TestCase {
    ...
    public function UploadAPI($updatedCustomer, $extraData, $event_name) {
        ...
        $netcoreTrack = new Upload($this->getHeaders());
        $response = $netcoreTrack->POST($requestData);
